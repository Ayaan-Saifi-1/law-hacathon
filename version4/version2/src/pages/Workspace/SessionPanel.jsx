    ...
    <aside className="session-panel">
      ...
      <div className="panel-section">
        <div className="panel-section-title">
          ...
          <Badge variant="gold">IN SESSION</Badge>
        </div>
        {currentCase ? (
            ...
            return (
              <div
                ...
                style={{
                  padding: "10px 12px",
                  borderRadius: "5px",
                  backgroundColor: isWitnessActive ? "rgba(197, 160, 89, 0.08)" : "var(--c-surface-elevated)",
                  border: `1px solid ${isWitnessActive ? "var(--c-gold)" : "var(--c-border)"}`,
                  cursor: "pointer",
                }}
              >
                  ...
                  <div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
                    <span
                      style={{
                        ...
                        fontWeight: 700,
                        fontSize: "11px",
                        color: isWitnessActive ? "var(--c-gold)" : "var(--c-text-secondary)",
                      }}
                    >
                      {wit.code}
                    </span>
        ...
        {exhibitsMarked.length === 0 ? (
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "6px" }}>
            {exhibitsMarked.map((ex) => (
              ...
              >
                <div style={{ color: "var(--c-gold)", fontWeight: 700, fontFamily: "var(--font-mono)" }}>
                  {ex.exhibitNo}
                </div>
