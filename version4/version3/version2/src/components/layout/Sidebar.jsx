  ...
  const navLinks = [
    {
      ...
      items: [
        { path: "/causelist", label: "Daily Cause List", icon: "◎" },
        { path: "/workspace", label: "Stenographer Workspace", icon: "◈" },
        { path: "/archive", label: "Precedent Archive", icon: "⊞" },
      ],
    },
    {
      group: "ADMINISTRATION",
      items: [
        { path: "/admin", label: "Daily Roznama & Bench", icon: "◧" },
      ],
    },
  ];
              ...
              {section.items.map((item) => (
                <NavLink
                  ...
                  style={({ isActive }) => ({
                    ...
                    backgroundColor: isActive ? "var(--c-surface-elevated)" : "transparent",
                ...
                >
                  <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
                    <span style={{ fontSize: "14px", width: "16px", textAlign: "center", color: "var(--c-gold)" }}>
                      {item.icon}
                    </span>
            ...
            {MOCK_USERS.map((u) => (
              <div
                ...
                style={{
                  ...
                  alignItems: "center",
                  gap: "10px",
                  backgroundColor: u.id === currentUser.id ? "var(--c-surface)" : "transparent",
                  color: u.id === currentUser.id ? "var(--c-gold)" : "var(--c-text-primary)",
                }}
              >
                <div
                  style={{
