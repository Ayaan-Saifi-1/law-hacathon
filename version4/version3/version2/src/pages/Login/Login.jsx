                    ...
                    <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
                      <div
                        style={{
                          ...
                          height: "36px",
                          borderRadius: "50%",
                          backgroundColor: isSelected ? "var(--c-gold)" : "var(--c-surface)",
                          ...
                          fontSize: "12px",
                          fontWeight: 700,
                          color: isSelected ? "var(--c-surface)" : "var(--c-text-secondary)",
                        }}
                      >
                        {user.avatar}
                      </div>
                      <div>
                        <div style={{ fontSize: "13px", fontWeight: 600, color: isSelected ? "var(--c-gold)" : "var(--c-text-primary)" }}>
                          {user.name}
                        </div>
