          ...
          >
            <div className="case-card-grid">
              ...
              <div>
                <div
                  style={{
                    ...
                    fontSize: "18px",
                    fontWeight: 700,
                    color: isInProgress ? "var(--c-navy)" : "var(--c-text-secondary)",
                  }}
                >
                  #{c.itemNo}
                </div>
              ...
              <div>
                ...
                <div style={{ fontSize: "12px", color: "var(--c-navy)", marginTop: "4px", fontWeight: 600 }}>
                  {c.sections}
                </div>
              </div>
              ...
              <div>
                <div style={{ fontSize: "13px", fontWeight: 600, color: "var(--c-text-primary)", lineHeight: 1.4 }}>
                  {c.petitioner} <span style={{ color: "var(--c-text-muted)", fontWeight: 400 }}>vs.</span> {c.respondent}
                </div>
                ...
                {c.witnessName && c.witnessName !== "N/A" && (
                  <div style={{ fontSize: "11px", color: "var(--c-navy)", marginTop: "2px", fontWeight: 600 }}>
