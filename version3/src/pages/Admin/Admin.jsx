    ...
    <div className="admin-page">
      ...
      <div className="admin-header">
        ...
        <div style={{ display: "flex", gap: "10px" }}>
          <Button variant="primary" size="sm" onClick={() => exportRoznamaCsv(roznama)}>
        ...
        <div className="roznama-table-container">
          <table className="roznama-table">
            ...
            <tbody>
              {roznama.map((row) => (
                <tr key={row.id}>
                  <td style={{ fontFamily: "var(--font-mono)", fontWeight: 700, color: "var(--c-navy)" }}>
                    #{row.itemNo}
                  </td>
                  <td>
      ...
      {activeTab === "audit" && (
        ...
        >
          <h3 style={{ fontSize: "14px", fontWeight: 700, color: "var(--c-navy)", marginBottom: "16px" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "10px", fontFamily: "var(--font-mono)", fontSize: "12px" }}>
            <div style={{ padding: "10px 14px", backgroundColor: "var(--c-surface-elevated)", borderRadius: "4px", border: "1px solid var(--c-border)" }}>
              ...
              <strong style={{ color: "var(--c-navy)" }}>SESSION_START</strong>: Sessions Case No. 14/2024 opened by Stenographer Gr-I (Rajeshwar Sharma).
            </div>
            <div style={{ padding: "10px 14px", backgroundColor: "var(--c-surface-elevated)", borderRadius: "4px", border: "1px solid var(--c-border)" }}>
              <span style={{ color: "var(--c-text-muted)" }}>[10:31:02 IST]</span>{" "}
              <strong style={{ color: "var(--c-navy-light)" }}>OATH_ADMINISTERED</strong>: PW-2 SI Vikram Rathore sworn on Solemn Affirmation under Indian Oaths Act.
            </div>
            <div style={{ padding: "10px 14px", backgroundColor: "var(--c-surface-elevated)", borderRadius: "4px", border: "1px solid var(--c-border)" }}>
              <span style={{ color: "var(--c-text-muted)" }}>[10:31:40 IST]</span>{" "}
              <strong style={{ color: "var(--c-navy)" }}>STAGE_TRANSITION</strong>: Proceeding transitioned to 'Cross-Examination'.
            </div>
            <div style={{ padding: "10px 14px", backgroundColor: "var(--c-surface-elevated)", borderRadius: "4px", border: "1px solid var(--c-border)" }}>
              <span style={{ color: "var(--c-text-muted)" }}>[10:34:02 IST]</span>{" "}
              <strong style={{ color: "var(--c-navy)" }}>EXHIBIT_TENDERED</strong>: Ex. PW-2/B admitted onto judicial record without objection.
            </div>
            <div style={{ padding: "10px 14px", backgroundColor: "var(--c-surface-elevated)", borderRadius: "4px", border: "1px solid var(--c-border)" }}>
      ...
      {activeTab === "integration" && (
        ...
        >
          <h3 style={{ fontSize: "15px", fontWeight: 700, color: "var(--c-navy)", marginBottom: "8px" }}>
          ...
          <p style={{ fontSize: "13px", color: "var(--c-text-secondary)", lineHeight: 1.6, marginBottom: "16px" }}>
            ...
            <code style={{ color: "var(--c-navy)", fontFamily: "var(--font-mono)" }}>src/services/courtDataBridge.js</code>.
