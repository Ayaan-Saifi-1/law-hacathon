      ...
      <div className="login-card">
        ...
        <form onSubmit={handleLogin} className="login-body">
                    ...
                    <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
                      <div
                        style={{
                          ...
                          height: "40px",
                          borderRadius: "2px",
                          backgroundColor: isSelected ? "var(--c-gold-gradient)" : "var(--c-surface-elevated)",
                          border: `1px solid ${isSelected ? "var(--c-gold-border)" : "var(--c-border)"}`,
                          display: "flex",
                          alignItems: "center",
                      ...
                      <div>
                        <div style={{ fontSize: "14px", fontWeight: 700, color: isSelected ? "var(--c-gold-hover)" : "var(--c-text-primary)" }}>
                          {user.name}
                        </div>
          ...
          <Button
            ...
            variant="gold"
            size="lg"
            style={{ width: "100%", justifyContent: "center", borderRadius: "var(--radius-md)", fontSize: "15px" }}
          >
